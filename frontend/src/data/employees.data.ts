...
export const sampleLeaveBalances: LeaveBalance[] = [
  ...
  { leaveTypeId: 'bereavement', leaveTypeName: 'Bereavement Leave', entitled: 5, taken: 0, pending: 0, balance: 5, carriedForward: 0 },
